  ...
  <div class="card" style="width: 540px;">
    <div class="row no-gutters">
      <div class="col-md-4" style="display: flex;justify-content: center;">
        <?php if ($success) {
        echo
        '<svg width="12rem" fill="red" viewBox="0 0 16 16" class="bi bi-heart card-svg" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          echo '<svg width="10rem" viewBox="0 0 16 16" class="bi bi-emoji-frown card-svg" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

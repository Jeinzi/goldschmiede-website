...
<div class="container">
    <div class="row">
        <div class="col-12">
            <h1 class="main-heading border-bottom">Tags
                <button id="button-add-tag" title="Tags hinzufügen" class="btn btn-outline-input btn-outline-secondary" style="float: right;margin-top: 0.35rem;">
    ...
    <div class="row">
        <div id="tag-container" class="col-md-4 mb-3">
            <?php
                try {
      ...
      ?></div>
        <div class="col-md-8">
            ...
            <div class="row">
                <div class="col">
                    <button id="button-delete" data-toggle="modal" data-target="#delete-confirmation" class="btn btn-outline-input btn-danger">
